...
implement_sigs! {
    ...
    ("cross") CrossRspd128Fast: OQS_SIG_alg_cross_rsdp_128_fast,
    ("cross") CrossRspd128Small: OQS_SIG_alg_cross_rsdp_128_small,
    ("cross") CrossRspd192Balanced: OQS_SIG_alg_cross_rsdp_192_balanced,
    ("cross") CrossRspd192Fast: OQS_SIG_alg_cross_rsdp_192_fast,
    ("cross") CrossRspd192Small: OQS_SIG_alg_cross_rsdp_192_small,
    ("cross") CrossRspd256Balanced: OQS_SIG_alg_cross_rsdp_256_balanced,
    ("cross") CrossRspd256Fast: OQS_SIG_alg_cross_rsdp_256_fast,
    ("cross") CrossRspd256Small: OQS_SIG_alg_cross_rsdp_256_small,
    ("cross") CrossRspdg128Balanced: OQS_SIG_alg_cross_rsdpg_128_balanced,
    ("cross") CrossRspdg128Fast: OQS_SIG_alg_cross_rsdpg_128_fast,
    ("cross") CrossRspdg128Small: OQS_SIG_alg_cross_rsdpg_128_small,
    ("cross") CrossRspdg192Balanced: OQS_SIG_alg_cross_rsdpg_192_balanced,
    ("cross") CrossRspdg192Fast: OQS_SIG_alg_cross_rsdpg_192_fast,
    ("cross") CrossRspdg192Small: OQS_SIG_alg_cross_rsdpg_192_small,
    ("cross") CrossRspdg256Balanced: OQS_SIG_alg_cross_rsdpg_256_balanced,
    ("cross") CrossRspdg256Fast: OQS_SIG_alg_cross_rsdpg_256_fast,
    ("cross") CrossRspdg256Small: OQS_SIG_alg_cross_rsdpg_256_small,
}
